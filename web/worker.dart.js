...
(function dartProgram() {
  ...
  A.SubListIterable.prototype = {
    ...
    skip$1(_, count) {
      ...
      newStart = B.JSInt_methods.$add(_this._start, count);
  ...
  A.SkipIterable.prototype = {
    skip$1(_, count) {
      this._skipCount.$add(0, A._checkCount(count));
      return void 1;
    },
    get$iterator(_) {
  ...
  A.EfficientLengthSkipIterable.prototype = {
    get$length(_) {
      var $length = B.JSInt_methods.$sub(J.get$length$asx(this.__internal$_iterable), this._skipCount);
      if ($length >= 0)
        return $length;
      return 0;
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.SkipIterable, A._KeysOrValues]);
